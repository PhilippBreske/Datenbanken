...
INSERT ALL
    ...
    INTO Krankschreibung (Kosten, Art, Grund, Dauer, AID, PaID) VALUES (85, 'Erstbescheinigung', 'Hautinfektion', 6, 'AID17', 'P17')
    INTO Krankschreibung (Kosten, Art, Grund, Dauer, AID, PaID) VALUES (75, 'Folgebescheinigung', 'Nierenprobleme', 14, 'AID18', 'P18')
    INTO Krankschreibung (Kosten, Art, Grund, Dauer, AID, PaID) VALUES (60, 'Erstbescheinigung', 'Augeninfektion', 5, 'AID19', 'P19')
    INTO Krankschreibung (Kosten, Art, Grund, Dauer, AID, PaID) VALUES (90, 'Folgebescheinigung', 'Diabetes', 20, 'AID20', 'P20')
    INTO Krankschreibung (Kosten, Art, Grund, Dauer, AID, PaID) VALUES (55, 'Erstbescheinigung', 'Ernährungsberatung', 3, 'AID21', 'P21')
    INTO Krankschreibung (Kosten, Art, Grund, Dauer, AID, PaID) VALUES (80, 'Folgebescheinigung', 'Psychosomatische Beschwerden', 12, 'AID22', 'P22')
    INTO Krankschreibung (Kosten, Art, Grund, Dauer, AID, PaID) VALUES (65, 'Erstbescheinigung', 'Zahnprobleme', 5, 'AID23', 'P23')
    INTO Krankschreibung (Kosten, Art, Grund, Dauer, AID, PaID) VALUES (75, 'Folgebescheinigung', 'Herzrhythmusstörungen', 18, 'AID24', 'P24')
    INTO Krankschreibung (Kosten, Art, Grund, Dauer, AID, PaID) VALUES (55, 'Erstbescheinigung', 'Hörsturz', 4, 'AID25', 'P25')
    INTO Krankschreibung (Kosten, Art, Grund, Dauer, AID, PaID) VALUES (70, 'Folgebescheinigung', 'Arbeitsüberlastung', 15, 'AID26', 'P26')
    INTO Krankschreibung (Kosten, Art, Grund, Dauer, AID, PaID) VALUES (95, 'Erstbescheinigung', 'Blasenentzündung', 7, 'AID27', 'P27')
    INTO Krankschreibung (Kosten, Art, Grund, Dauer, AID, PaID) VALUES (60, 'Folgebescheinigung', 'Schilddrüsenprobleme', 14, 'AID28', 'P28')
    INTO Krankschreibung (Kosten, Art, Grund, Dauer, AID, PaID) VALUES (80, 'Erstbescheinigung', 'Rheumatische Beschwerden', 20, 'AID29', 'P29')
    INTO Krankschreibung (Kosten, Art, Grund, Dauer, AID, PaID) VALUES (85, 'Langzeit', 'Rheumatische Beschwerden', 20, 'AID30', 'P30')
SELECT 1 FROM dual;
